...
//  We are not going to use instance of this structure 
//  in this code. This is here only to explain the design 
//  where in struct for node and structure for data structure 
//  instance are same ! 
...
{
    build_bst();
    puts("Application termianted successfully");
    return (0); 
}
